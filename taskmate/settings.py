...
CSRF_TRUSTED_ORIGINS = env('DJANGO_CSRF_TRUSTED_ORIGINS', default='http://localhost,http://127.0.0.1').split(',')
...
# Make sure all database variables are set in your .env file
DATABASES = {
    'default': {
